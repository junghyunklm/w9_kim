    ...
    if (typeof prevImg !== 'undefined') {
        ...
        for (let x = 0; x < currImg.width; x += 1) {
            for (let y = 0; y < currImg.height; y += 1) {
                ...
                let redSource = currImg.pixels[index + 2];
                let greenSource = currImg.pixels[index + 1];
                let blueSource = currImg.pixels[index + 0];
                ...
                if (d > threshold) {
                    ...
                    diffImg.pixels[index + 0] = 100;
                    diffImg.pixels[index + 1] = 100;
                    diffImg.pixels[index + 2] = 100;
                    diffImg.pixels[index + 3] = 100;
                }
